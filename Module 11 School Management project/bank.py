...
class Account(ABC):
    ...
    def changeInfo(self,name,passW=None):
        if passW is None:
           self.name=name
    ...
    if currentUser==None:
        ...
        if currentUser.type=="savings":
            ...
            if op==1:
                ...
                #acc=Account(currentUser)
                if currentUser.type == "savings":
                    op = input("Change Name or Name and password (N/N and P): ")
                    if op == "N":
                      nm = input("Name: ")
                      currentUser.changeInfo(nm)
                    else:
                      nm = input("Name: ")
                      passw = input("Password: ")
                      currentUser.changeInfo(nm, passw)
